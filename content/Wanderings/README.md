...
- **November 2023**: discovered the "Zettelkasten System" and started to use this within Obsidian. This was the birth of the "Idea" note.
	- This was the video that got me started: https://youtu.be/E6ySG7xYgjY?feature=shared
...
- **May 2024**: started writing more "formal" ideas = essays
	- I would say essay writing started back in December 2023, but back then essays and ideas were one and the same. Around May is when I created a new folder to put all my essays into. I also began publishing on [Medium](https://medium.com/@wanderingmeditations) (all links can be found at the bottom of this page and every page on this website).
...
- example: I'm reading a passage and it reminds me of a quote/passage from another book
Sometimes I may use an outgoing link to an 'Idea' note if I can't fit the current 'Library' note into that 'Idea' note in any meaningful way, or if a significant part of the book contributes to that 'Idea' note, in which case I usually don't bother summarizing that in the 'Library' note itself but rather keep it for the 'Idea' note.
